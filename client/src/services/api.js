...
export const bookingsApi={create:(d)=>api.post('/bookings',d),get:()=>api.get('/bookings'),update:(id,d)=>api.put(`/bookings/${id}`,d),remove:(id)=>api.delete(`/bookings/${id}`),notifications:()=>api.get('/bookings/notifications'),readNotification:(id)=>api.put(`/bookings/notifications/${id}/read`)}; export const catalogApi={portfolio:()=>api.get('/portfolio'),services:()=>api.get('/services')}; export const siteApi={get:()=>api.get('/site')};
